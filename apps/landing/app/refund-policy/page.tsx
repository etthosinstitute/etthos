            ...
            <article className="bg-surface-card p-8 md:p-12 lg:p-16 rounded-2xl shadow-xl border border-surface-contrast/5">
              ...
              <section className="mb-12">
                ...
                <p className="text-text-muted leading-relaxed">
                  We truly appreciate the opportunity to serve you and are
                  committed to delivering the highest standard of service in
                  everything we do. If for any reason you are not fully
                  satisfied with our service, we&apos;re here to help.
                </p>
              </section>
              ...
              <section className="mb-12">
                ...
                <div className="bg-brand-amber/10 border-l-4 border-brand-amber p-6 rounded-r-xl mb-8">
                  <p className="font-bold text-brand-amber mb-4 text-lg">
                    ⚠️ Important Notice
                  </p>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3 text-text-muted">
                      ...
                      <span>
                        ...
                        Once customers make a purchase, they will not be able to
                        return that item for a replacement or refund.
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-text-muted">
                      <span className="w-2 h-2 rounded-full bg-brand-amber mt-2 flex-shrink-0"></span>
                      <span>
                        ...
                        No monetary refunds will be given for any reason, though
                        alternative refunds may be offered, such as store credit
                        or exchanges.
                      </span>
                    </li>
                  </ul>
                ...
                <p className="text-text-muted leading-relaxed">
                  Refunds will be considered only in accordance with the
                  specific cancellation and refund policies mentioned on the
                  course or service detail pages. Once services have commenced
                  or materials have been accessed, refunds may not be
                  applicable.
                </p>
              </section>
              ...
              <section>
                <h2 className="text-xl md:text-2xl font-bold text-text-high mb-6 pb-3 border-b border-surface-contrast/10">
                  <span className="text-brand-cyan mr-2">3.</span>Customer
                  Support
                </h2>
                <div className="bg-surface-soft p-6 rounded-xl border border-surface-contrast/10 space-y-4">
                  <p className="text-text-muted flex items-center gap-3">
                    ...
                    <span>
                      <strong className="text-text-high">Phone:</strong>{" "}
                      <a
                  ...
                  <p className="text-text-muted flex items-center gap-3">
                    <span className="text-brand-cyan text-xl">🕐</span>
                    <span>
                      <strong className="text-text-high">Available:</strong>{" "}
