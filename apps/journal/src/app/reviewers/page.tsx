      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="font-serif text-3xl font-bold text-primary mb-4">Why Review for Etthos?</h2>
              <p className="text-muted-foreground leading-relaxed">
                Peer reviewers are the backbone of scholarly publishing. By joining our board, you play a critical role in maintaining the integrity and quality of research in psychology.
              </p>
            </div>
            ...
            <div className="grid gap-6">
              {[
                ...
                <div key={idx} className="flex gap-4 p-5 rounded-2xl bg-secondary/5 border border-secondary/10">
            ...
            <div className="p-8 rounded-[1.75rem] border border-[hsl(var(--highlight)/0.2)] bg-[hsl(var(--highlight)/0.03)]">
              <h3 className="font-serif text-xl font-bold text-primary mb-4">Our Commitment</h3>
          ...
          <div className="relative">
            <div className="sticky top-24 rounded-[2rem] border border-border bg-card p-8 shadow-[0_30px_70px_-40px_rgba(19,34,56,0.3)]">
              <div className="mb-8">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-secondary mb-2">Expression of Interest</p>
                <h2 className="font-serif text-2xl font-bold text-primary">Reviewer Application</h2>
              </div>
              ...
              {success ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                    Thank you for your interest in joining our review board. Our editorial team will review your credentials and contact you shortly.
                  </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">Institutional Affiliation</label>
                    <input
                      type="text"
                      required
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">Areas of Expertise</label>
                    <textarea
                      required
                      rows={3}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">ORCID iD (Optional)</label>
                    <input
                      type="text"
                  ...
                  <Button type="submit" disabled={loading} className="w-full h-12 rounded-xl text-base shadow-lg shadow-secondary/20 mt-4">
                    {loading ? "Sending Application..." : "Submit Application"}
                  </Button>
                  
                  <p className="text-[11px] text-center text-muted-foreground px-4">
                    By submitting, you agree to follow the journal's <span className="text-secondary font-medium">COPE-compliant</span> ethical guidelines for peer review.
                  </p>
                </form>
              )}
            </div>
