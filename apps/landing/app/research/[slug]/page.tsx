...
export async function generateStaticParams() {
  return researchServices.map((service) => ({
    slug: service.slug,
  }));
}

const ResearchServicePage = async ({ params }: PageProps) => {
        ...
        <div className="container mx-auto px-4 md:px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
            <div className="bg-surface-card p-6 rounded-2xl border border-slate-200/60 dark:border-white/10 flex flex-col items-start gap-4 hover:shadow-lg transition-all">
              ...
              <div>
                <h3 className="text-text-muted font-medium text-sm uppercase tracking-wider mb-1">Research</h3>
                <p className="text-lg font-bold text-text-high">Evidence-Based Methods</p>
              </div>
            </div>
            ...
            <div className="bg-surface-card p-6 rounded-2xl border border-slate-200/60 dark:border-white/10 flex flex-col items-start gap-4 hover:shadow-lg transition-all">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-text-high">{service.deliveryMode || "Flexible"}</p>
              </div>
            </div>
            ...
            <div className="bg-surface-card p-6 rounded-2xl border border-slate-200/60 dark:border-white/10 flex flex-col items-start gap-4 hover:shadow-lg transition-all">
              ...
              <div>
                <h3 className="text-text-muted font-medium text-sm uppercase tracking-wider mb-1">Standard</h3>
                <p className="text-lg font-bold text-text-high">Global Quality</p>
              </div>
            </div>
          </div>
