  ...
  return (
    <>
      <PageHeader 
        ...
        description={guidelinesPage.description || "Everything you need to know to prepare and submit your manuscript to the Etthos Journal of Psychology."}
      />
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="prose prose-slate max-w-none rounded-[1.75rem] border border-border bg-card p-8 text-muted-foreground shadow-[0_20px_60px_-48px_rgba(19,34,56,0.42)]">
              <p className="not-prose mb-3 text-xs font-semibold uppercase tracking-[0.28em] text-secondary">Author Preparation</p>
            ...
            <div className="sticky top-24 rounded-[1.5rem] border border-border bg-card p-6 shadow-[0_18px_50px_-42px_rgba(19,34,56,0.42)]">
              ...
              <div className="space-y-4">
                {guidelinesPage.content.resources.map((resource) => {
                  ...
                  return (
                    <div key={resource.title} className="flex items-start gap-3 rounded-2xl border border-border bg-background/70 p-4">
                      ...
                      <div>
                        ...
                        <Button asChild variant="outline" size="sm" className="w-full text-xs h-8">
                          <a href={resource.href} target="_blank" rel="noopener noreferrer">
                            <Download className="h-3 w-3 mr-2" /> {resource.ctaLabel}
                          </a>
                        </Button>
                      </div>
                    </div>
