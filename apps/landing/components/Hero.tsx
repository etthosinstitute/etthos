        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-8 max-w-xl order-2 lg:order-1 pt-10 lg:pt-0">
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-text-high dark:text-white">
              <Badge className="border-brand-cobalt/20 bg-brand-cobalt/10 text-brand-cobalt backdrop-blur-sm dark:border-brand-cobalt/20 dark:bg-brand-cobalt/10 dark:text-brand-cobalt">
                New Batch 2026
              </Badge>
              <Badge className="border-brand-cyan/15 bg-brand-cyan/8 text-brand-cyan shadow-sm backdrop-blur-sm dark:border-brand-cyan/15 dark:bg-brand-cyan/8 dark:text-brand-cyan">
                As per latest DSM - 5 - TR and ICD - 11 Norms.
              </Badge>
            </div>
            ...
            <p className="max-w-xl text-lg font-medium leading-relaxed text-text-muted dark:text-white/78">
              The premier institute for modern psychology. We bridge the gap
              between academic theory and real-world clinical practice with
            ...
            <div className="mt-8 flex items-center gap-6 border-t border-slate-200/80 pt-8 dark:border-white/10">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-sm text-text-high dark:text-white">
          ...
          <div className="relative order-1 h-125 lg:h-175 w-full lg:order-2">
            ...
            <div className="absolute top-10 left-0 animate-bounce-slow">
              <div className="max-w-45 rounded-2xl border border-slate-100 bg-white/94 p-4 shadow-xl dark:border-white/10 dark:bg-slate-800">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-xs font-bold text-text-high dark:text-white">
                    Certified
                  </div>
                </div>
                <div className="text-[10px] text-slate-500 dark:text-slate-300 leading-tight">
                  RCI recognized excellence in training
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-20 -left-10 lg:left-10 z-20 hidden md:block">
              <div className="flex items-center gap-3 rounded-full border border-slate-100 bg-white/94 p-3 pr-6 shadow-glow dark:border-white/10 dark:bg-slate-800">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-text-high dark:text-white">
                    4.9/5 Rating
                  </span>
