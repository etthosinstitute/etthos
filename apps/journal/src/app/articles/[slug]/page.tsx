...
import {
  generateCitation,
  getRecommendedCitation,
} from "@/features/public-site/citations";
import {
  Calendar,
  Download,
  Quote,
...
export async function generateMetadata({
  ...
  return {
    ...
    other: {
      ...
      ...(article.pageStart
        ? { citation_firstpage: String(article.pageStart) }
        : {}),
      ...(article.pageEnd
        ? { citation_lastpage: String(article.pageEnd) }
        : {}),
    },
  };
}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-7 space-y-2">
              {article.authors.map((author, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2 text-[15px] text-primary-foreground/82"
                >
                  ...
                  {author.isCorresponding && (
                    <span className="ml-1 text-[hsl(var(--highlight))] text-xs">
                      ✉ Corresponding
                    </span>
                  )}
                </div>
            ...
            {article.doi && (
              <p className="mb-6 text-sm text-primary-foreground/60">
                DOI:{" "}
                <span className="font-mono text-xs text-[hsl(var(--highlight))]">
                  {article.doi}
                </span>
              </p>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
          ...
          <article className="lg:col-span-2 space-y-10">
            ...
            <div className="journal-shell p-8">
              ...
              <p className="journal-body max-w-none">{article.abstract}</p>
            </div>
            ...
            {article.references && article.references.length > 0 && (
              <div>
                <h3 className="journal-heading mb-4 text-xl font-bold">
                  References
                </h3>
            ...
            <div id="citation-formats" className="border-t border-border pt-8">
              ...
              <div className="journal-panel mb-4 p-4">
                <span className="journal-kicker mb-2 block tracking-[0.18em]">
          ...
          <aside className="space-y-8">
            <div className="journal-shell sticky top-24 p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                {article.doi && (
                  <div className="flex justify-between items-center pt-1">
                    ...
                    <span className="font-medium text-secondary text-xs font-mono">
                      {article.doi}
                    </span>
                  </div>
                )}
              ...
              <div className="mt-8">
                <h4 className="journal-kicker mb-3 tracking-[0.18em]">
                  Authors
                </h4>
