  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (message.includes("Unauthorized")) {
        ...
        message.includes("Only author accounts can submit manuscripts")
      ) {
  ...
  return (
    <>
      <PageHeader
        ...
        description={
          <>
            Share your research in psychology and behavioural sciences with the
        ...
        <div className="mx-auto max-w-3xl rounded-[1.75rem] border border-border bg-card p-8 shadow-[0_20px_60px_-48px_rgba(19,34,56,0.42)]">
          <div className="mb-8 text-center">
            ...
            <h2 className="font-serif text-3xl font-bold text-primary">
              Prepare your manuscript for editorial review
            </h2>
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              Submit your title, abstract, and manuscript file link. You will be
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-xs text-muted-foreground">
                Use the final scholarly title that should appear in editorial
                records.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="mt-2 text-xs text-muted-foreground">
                Please provide at least 50 characters so the editors can assess
                scope and fit quickly.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-2">
                Upload a PDF, DOC, or DOCX file up to 10MB. The file will be
                stored and attached to your submission.
              </p>
              <input
                type="file"
            ...
            <div className="pt-4">
              ...
              {!authLoading && !isAuthenticated ? (
                ...
                <p className="mt-3 text-center text-xs text-muted-foreground">
                  Only accounts with the <code>AUTHOR</code> role can submit
                  manuscripts.
                </p>
              ) : !submitReady ? (
                <p className="mt-3 text-center text-xs text-muted-foreground">
                  Add a title, an abstract of at least 50 characters, and your
                  manuscript file to continue.
                </p>
              ) : null}
            </div>
          </form>
