...
export const editorialBoard: EditorialBoardMemberData[] = [
  ...
  },
  {
    ...
    biography: "Dr. Priyanka heads the Amity Institute of Behavioural and Allied Sciences (AIBAS) at Amity University Haryana. She established a Centre of Excellence for Psychometric Testing and holds three design patents in mental health innovation, including a VR Device for Mental Health Diagnostics.",
    displayOrder: 6,
  },
  {
    id: "sanjay-jha",
...
export const articles: ArticleData[] = [
  {
    ...
    authors: [
      ...
      { name: "Dr. Priyanka", affiliation: "Amity University Haryana", country: "India" },
    ],
  ...
  },
  {
    ...
    authors: [
      { name: "Dr. Priyanka", affiliation: "Amity University Haryana", country: "India", isCorresponding: true },
