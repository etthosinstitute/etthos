      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {content.features.map((feature) => {
            ...
            return (
              <div key={`${feature.eyebrow}-${feature.title}`} className="group journal-panel relative overflow-hidden p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:border-secondary/25">
                 ...
                 <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.24em] text-muted-foreground">{feature.eyebrow}</p>
                 <h3 className="mb-3 font-serif text-2xl font-semibold text-primary">{feature.title}</h3>
