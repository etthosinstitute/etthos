...
export const trainingCourses: TrainingCourse[] = [
  ...
  },
  {
    ...
    faqs: [
      {
        question:
          "Is this internship suitable for someone with no clinical exposure?",
        answer:
  ...
  },
  {
    ...
    deliveryMode:
      "Online Live Sessions with Practical Assignments and Peer Discussions",
    certification:
    ...
    faqs: [
      {
        question:
          "Is this internship suitable for someone with no HR background?",
        answer:
          "Yes. The course starts with basics and builds up to applied organizational strategies.",
      },
      {
        question: "Will I get hands-on project experience?",
        answer:
          "Yes. You will work on simulated organizational tasks and real case studies.",
      },
      {
        question:
          "Can this internship help me transition into HR or corporate roles?",
        answer:
...

  {
    ...
    deliveryMode:
      "Live Online Training with Assignments, Reading Packs, and Recorded Feedback Sessions",
    certification:
      "Hardcopy of Professional Certificate issued by Etthos Institute under RCI Licensed Clinical Psychologist",
    benefits: [
    ...
    faqs: [
      {
        ...
        answer:
          "No. This certification covers both foundational and advanced content with tiered learning paths.",
      },
      {
        question: "Will I receive supervision during practice?",
        answer:
          "Yes. Each batch includes supervised feedback sessions and Q&A with senior clinical psychologists.",
      },
      {
        question: "Will I be qualified to practice after this course?",
        answer:
          "This course builds applied psychotherapy skills. Practice depends on your academic eligibility and local regulations.",
      },
      {
        question: "Are assignments mandatory?",
        answer:
          "Yes. Assignments ensure integration of theory into practice and are required for certification.",
      },
    ],
  },
  {
    ...
    durationOptions: ["6 Weeks", "8 Weeks"],
    deliveryMode:
      "Live Online with Guided Case Simulations, Reflection Logs, and Support Resources",
    certification:
      "Professional Certificate issued under the mentorship of RCI Licensed Clinical Psychologists",
    benefits: [
    ...
    faqs: [
      {
        ...
        answer:
          "No. Foundational psychological knowledge is sufficient; clinical exposure is an advantage.",
      },
      {
        question: "Will we interact with real case studies?",
        answer:
          "Yes. Structured case narratives and clinical vignettes will be part of the training experience.",
      },
      {
        question: "Will this course cover caregiver counselling?",
        answer:
          "Absolutely. Special emphasis is placed on family and caregiver dynamics in psycho-oncology.",
      },
      {
        question: "Is this course useful for hospital-based professionals?",
        answer:
          "Yes. It is designed to empower hospital counsellors, nurses, and allied workers in oncology or chronic care departments.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        question:
          "Is this programme focused on practical assessment work or only theory?",
        answer:
      ...
      {
        question:
          "Will therapeutic and rehabilitation modalities also be covered?",
        answer:
      ...
      {
        question:
          "Does the programme include neuroimaging and forensic relevance?",
        answer:
  ...
  },
  {
    ...
    deliveryMode:
      "Live Online Classes with Practice Worksheets, SPSS Datasets, and Submission Feedback",
    certification:
      "Hardcopy of Professional Certificate issued under the guidance of research mentors and clinical psychologists",
    benefits: [
    ...
    faqs: [
      {
        ...
        answer:
          "No. Basic familiarity helps but all concepts will be introduced from foundational levels.",
      },
      {
        question: "Will I learn SPSS hands-on?",
        answer:
          "Yes. The course includes live software demonstrations, exercises, and supervised data interpretation.",
      },
      {
        question: "Can this help me prepare for PhD entrances or thesis work?",
        answer:
          "Definitely. Many participants use this certification to strengthen their research credentials.",
      },
      {
        question: "Will I work on a project during the program?",
        answer:
          "Yes. Each participant will complete either a mini-proposal or dataset analysis with mentor feedback.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      {
        question:
          "Will career, emotional intelligence, and forensic tools also be covered?",
        answer:
      ...
      {
        question:
          "Is report writing part of the programme or just an add-on topic?",
        answer:
  ...
  },
  {
    ...
    durationOptions: ["4 Weeks", "6 Weeks", "8 Weeks"],
    deliveryMode:
      "Live Online Sessions with Case Studies, Skill Demonstrations, and Assignment Feedback",
    certification:
      "Hardcopy Issued under the guidance of RCI Licensed Clinical Psychologists with performance evaluation",
    benefits: [
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. You will be trained in approaches to conduct parenting sessions and coach families.",
      },
      {
        question: "Is this program suitable for school counsellors?",
        answer:
          "Absolutely. It equips you to support parents, teachers, and students as part of the school ecosystem.",
      },
      {
        question:
          "Can this course help with issues like screen addiction or aggression in children?",
        answer:
          "Yes. Behavioral management techniques and child development insights are central to the training.",
      },
      {
        question: "Is it necessary to have a psychology background to join?",
        answer:
          "A basic understanding of psychology is recommended but not mandatory for educators or NGO professionals.",
      },
    ],
  },
  {
    ...
    category: "Certification",
    shortDescription:
      "Get certified in school counselling practices and develop the skills to promote student well-being, academic performance, and emotional resilience.",
    overview:
    ...
    durationOptions: ["4 Weeks", "6 Weeks", "8 Weeks"],
    deliveryMode:
      "Live Online Training with Case Simulations, Role Plays, and Assignments",
    certification:
      "Hardcopy Certificate issued under the supervision of RCI Licensed Clinical Psychologists with evaluation and project submission",
    benefits: [
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. Modules include classroom behavior, bullying, social anxiety, and peer adjustment.",
      },
      {
        question:
          "Is this suitable for teachers with no psychology background?",
        answer:
          "Yes. Teachers with interest in emotional development and student support are encouraged to apply.",
      },
      {
        question:
          "Will I be trained in how to collaborate with parents and school staff?",
        answer:
          "Absolutely. Parent-teacher partnerships and collaborative practices are key components of the program.",
      },
      {
        question: "Is it necessary to have a psychology background to join?",
        answer:
...

  {
    ...
    faqs: [
      ...
      {
        question:
          "Does the programme cover inclusive leadership and psychological safety?",
        answer:
  ...
  },
  {
    ...
    category: "Train The Trainer",
    shortDescription:
      "Train under legal and psychological experts to become a certified POSH trainer and lead awareness and compliance programs across organizations.",
    overview:
    ...
    deliveryMode:
      "Live Online Interactive Sessions + Roleplays + Trainer Simulations",
    certification:
      "Hardcopy Certificate issued jointly by Legal Professionals and RCI Licensed Psychologists",
    benefits: [
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. Licensed lawyers and consultants will conduct the legal modules.",
      },
      {
        question: "Can I join if I am not from a legal or HR background?",
        answer:
          "Yes. The training is open to any professional interested in building capacity in workplace safety.",
      },
      {
        question:
          "Will I be trained in how to handle disclosures during training?",
        answer:
          "Absolutely. Trauma-informed response and trainer conduct are essential parts of the course.",
      },
    ],
  },
  {
    ...
    durationOptions: ["1 Month"],
    deliveryMode:
      "Live Online Sessions with Group Activities, Discussions, and Trainer Evaluations",
    certification:
      "Hardcopy Certificate issued jointly by Licensed Psychologists, D&I Consultants, and Legal Trainers",
    benefits: [
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. The course prepares you to design, deliver, and evaluate such workshops effectively.",
      },
      {
        question:
          "Can I use this certification to conduct D&I training at workplaces?",
        answer:
          "Yes. The certification is suitable for freelance, internal, or consultancy-based D&I work.",
      },
      {
        question: "Do I need prior training experience to apply?",
        answer:
          "No. Prior experience is helpful but not necessary. The program includes trainer orientation modules.",
      },
      {
        question:
          "Will I learn to handle difficult conversations in diverse groups?",
        answer:
          "Absolutely. Roleplay and facilitation techniques are key parts of the program.",
      },
    ],
  },
  {
    ...
    category: "Train The Trainer",
    shortDescription:
      "Gain the skills to design, deliver, and assess impactful corporate training programs backed by behavioral science.",
    overview:
    ...
    deliveryMode:
      "Live Online + Practice Labs + Trainer Presentation Assessments",
    certification:
      "Hardcopy Issued by Etthos Institute with Corporate Training Professionals and Licensed Psychologists as mentors",
    benefits: [
    ...
    faqs: [
      {
        question:
          "Will I be taught how to create and deliver my own training modules?",
        answer:
          "Yes. The course includes content planning, structuring, and live delivery practice.",
      },
      {
        question: "Is this suitable for beginners in the training field?",
        answer:
          "Yes. Both beginners and professionals looking to enhance their skills are welcome.",
      },
      {
        question: "Will I get individual feedback on my training delivery?",
        answer:
          "Absolutely. Feedback and trainer evaluation are integral parts of the program.",
      },
      {
        question: "Will this help in freelance or in-house training roles?",
        answer:
          "Yes. The certification enables you to pursue both freelance and in-house opportunities.",
      },
    ],
  },
  {
    ...
    category: "Train The Trainer",
    shortDescription:
      "Build your expertise in delivering transformative soft skill programs that enhance communication, emotional intelligence, and leadership.",
    overview:
      "Empower Personal Growth – Become a Certified Soft Skills Trainer. Build your expertise in delivering transformative soft skill programs that enhance communication, emotional intelligence, leadership, and workplace effectiveness.",
    keyModules: [
    ...
    faqs: [
      {
        question:
          "Will I learn how to build my own soft skills training programs?",
        answer:
          "Yes. You will learn instructional design and get guided practice in building modules.",
      },
      {
        question:
          "Can this course help me enter the freelance training industry?",
        answer:
          "Absolutely. It provides the credibility and toolkit to begin freelance or institutional soft skills facilitation.",
      },
      {
        question: "Is there any prior experience required to join this course?",
        answer:
          "No. This course welcomes both beginners and professionals looking to refine their delivery style.",
      },
      {
        question: "Are personality development modules also covered?",
        answer:
          "Yes. You will learn to deliver sessions on confidence, mindset, and goal setting.",
      },
    ],
  },

  {
    ...
    category: "Diploma",
    shortDescription:
      "Build Professional Competence in Counselling – Enroll in Our Diploma Program designed for aspiring and practicing mental health professionals.",
    overview:
    ...
    deliveryMode:
      "Hybrid Model – Live Online Theory + Supervised Practical Assignments",
    certification:
      "Hardcopy Diploma awarded upon successful completion under RCI Licensed Clinical Psychologist supervision.",
    whoShouldJoin: [
    ...
    faqs: [
      {
        question:
          "Will I be eligible to work as a counsellor after this diploma?",
        answer:
          "Yes. This program builds necessary competence and practical readiness for institutional roles.",
      },
      {
        question: "Does this include career counselling training?",
        answer:
          "Yes. Career guidance and psychoeducational assessment modules are part of the curriculum.",
      },
      {
        question: "Is this diploma valid for school jobs?",
        answer:
          "Yes. Many schools and educational bodies accept this diploma for counselling-related posts.",
      },
      {
        question: "Will I have supervised practice during this course?",
        answer:
          "Yes. You will engage in practicum work under clinical psychologist guidance.",
      },
    ],
  },
  {
    ...
    deliveryMode:
      "Hybrid Model – Live Online Theory Sessions + Practical Counselling Projects",
    certification:
      "Hardcopy Diploma awarded upon successful completion under the guidance of RCI Licensed Clinical Psychologists.",
    whoShouldJoin: [
    ...
    faqs: [
      {
        question:
          "Will I be trained to work with new mothers and children together?",
        answer:
          "Yes. This program integrates family-based support strategies for both child and maternity care",
      },
      {
        question:
          "Is this diploma useful for hospital or maternity care settings?",
        answer:
          "Yes. It prepares professionals for emotional support roles in hospital and community care settings.",
      },
      {
        question: "Will postpartum concerns be addressed in this program?",
        answer:
          "Absolutely. Modules on postpartum depression, anxiety, and parenting stress are included.",
      },
      {
        question: "Can students of psychology apply for this diploma?",
        answer:
          "Yes. Undergraduate and postgraduate psychology students are welcome to apply.",
      },
    ],
  },
];
