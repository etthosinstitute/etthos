        ...
        <section className="relative py-20 lg:py-32 overflow-hidden bg-brand-midnight text-white">
          ...
          <div className="relative z-10 mx-auto max-w-[1440px] px-4 md:px-10 text-center">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight">
              ...
              <span className="text-brand-cyan">Psychology</span>
            </h1>
            <p className="max-w-3xl mx-auto text-lg md:text-xl text-slate-300 font-medium leading-relaxed">
              Etthos Institute of Behavioral Research and Training Pvt. Ltd. is
              a distinguished organization committed to excellence in the field
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-text-muted leading-relaxed">
                  <p>
                    Established with a vision to elevate the standards of
                    psychological education and application, Etthos offers
                    structured and practice-oriented training programs for
                    emerging psychologists. Our training modules are designed to
                    bridge the gap between theoretical frameworks and clinical
                    realities.
                  </p>
                  <p>
                    <strong className="text-text-high">Vision:</strong> To be a
                    pioneering institution in behavioral research and applied
                    psychology, empowering individuals, organizations, and
                    communities through transformative training, scientific
                    inquiry, and impactful psychological services.
                  </p>
                  <p>
                    <strong className="text-text-high">Mission:</strong> To
                    promote the practical application of psychology through
                    comprehensive education, advanced training, community
                    engagement, and research; and to uphold the highest
                    standards of ethical practice and professional excellence.
                  </p>
                </div>
        ...
        <section className="py-24 bg-surface-soft dark:bg-brand-ink/20">
          <div className="mx-auto max-w-[1440px] px-4 md:px-10">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 text-text-high">
                Meet Our Leadership
              </h2>
              <p className="text-text-muted text-lg max-w-2xl mx-auto">
                A dedicated team of professionals driving innovation in
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
              {team.map((member, index) => (
                <div key={index} className="group flex flex-col items-center">
                  ...
                  <p className="text-brand-cyan font-semibold text-xs md:text-sm uppercase tracking-wider mt-1">
                    {member.role}
                  </p>
                </div>
              ))}
