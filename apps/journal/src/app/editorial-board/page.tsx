...
export const metadata: Metadata = {
  ...
  description:
    "Meet the distinguished scholars guiding the Etthos Journal of Health, Behavior and Applied Psychology — profiles, affiliations, and areas of expertise.",
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="mx-auto mb-10 max-w-4xl text-center">
          ...
          <h2 className="font-serif text-3xl font-bold text-primary">
            Scholars guiding editorial quality and integrity
          </h2>
          <p className="mt-4 text-muted-foreground leading-7">
            The journal is supported by academics and practitioners with
            institutional affiliations, disciplinary expertise, and a shared
            commitment to rigorous review standards.
          </p>
        </div>
