        ...
        <div className="flex flex-col items-center justify-between gap-10 md:flex-row md:text-left">
          <div className="flex flex-col items-center md:items-start gap-6">
            ...
            <p className="max-w-xs text-sm text-slate-500 dark:text-slate-400 text-center md:text-left">
              Advancing psychology through research, training, and evidence-based practice.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 md:gap-16 text-center md:text-left">
            <div className="flex flex-col gap-3">
              ...
              <Link href="/about" className="text-sm text-slate-600 dark:text-slate-300 hover:text-brand-cyan dark:hover:text-brand-cyan transition-colors">About Us</Link>
              <Link href="/services" className="text-sm text-slate-600 dark:text-slate-300 hover:text-brand-cyan dark:hover:text-brand-cyan transition-colors">Services</Link>
              <a href="https://wa.me/+917261028965" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-600 dark:text-slate-300 hover:text-brand-cyan dark:hover:text-brand-cyan transition-colors">Contact</a>
            </div>
            <div className="flex flex-col gap-3">
              <h4 className="text-sm font-bold uppercase tracking-wider text-slate-900 dark:text-white">Legal</h4>
              <Link href="/privacy-policy" className="text-sm text-slate-600 dark:text-slate-300 hover:text-brand-cyan dark:hover:text-brand-cyan transition-colors">Privacy Policy</Link>
              <Link href="/terms-and-conditions" className="text-sm text-slate-600 dark:text-slate-300 hover:text-brand-cyan dark:hover:text-brand-cyan transition-colors">Terms & Conditions</Link>
              <Link href="/refund-policy" className="text-sm text-slate-600 dark:text-slate-300 hover:text-brand-cyan dark:hover:text-brand-cyan transition-colors">Refund Policy</Link>
            </div>
            <div className="flex flex-col gap-3 col-span-2 sm:col-span-1">
              <h4 className="text-sm font-bold uppercase tracking-wider text-slate-900 dark:text-white">Connect</h4>
