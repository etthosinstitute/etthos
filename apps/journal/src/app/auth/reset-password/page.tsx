...
function ResetPasswordContent() {
  ...
  const ready =
    token && form.password.length >= 8 && form.confirmPassword.length >= 8;
  const mismatch =
    ...
    <AuthCard>
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Reset links expire after 1 hour. Use a strong password with at least 8
          characters.
        </p>
      </div>
      ...
      {!token ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            disabled={loading || !ready || mismatch}
