...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact the Etthos Journal of Health, Behavior and Applied Psychology — editorial enquiries, submissions, and general information.",
};
    ...
    <>
      <PageHeader
        ...
        description={
          ...
          "We welcome enquiries from authors, reviewers, and readers."
        }
      />
            ...
            <div className="rounded-[1.5rem] border border-border bg-card p-6 shadow-[0_18px_50px_-42px_rgba(19,34,56,0.42)]">
              ...
              <ul className="space-y-5 text-sm text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-xs uppercase tracking-wider text-foreground mb-1">
