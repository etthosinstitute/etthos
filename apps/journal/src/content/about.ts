...
export const aboutContent: AboutContent = {
  overviewParagraphs: [
    "The Etthos Journal Of Health, Behavior and Applied Psychology (EJP) is a peer-reviewed, open-access academic journal published by Etthos. The journal is dedicated to the dissemination of high-quality original research, review articles, and scholarly discourse across the full spectrum of psychology and behavioural sciences.",
  ...
  foundersDescription:
    "Etthos Institute of Behavioral Research and Training Pvt. Ltd. was established with a vision to elevate the standards of psychological education, research, and applied training. The journal extends that broader institutional commitment into scholarly publishing.",
  founders: [
    { name: "Ram Vinoy Tiwari", role: "Director & Chairman", image: "/aboutusimages/ram-vinay-tiwari.jpeg" },
    { name: "Vishal Anand", role: "Director & CEO", image: "/aboutusimages/vishal-anand.jpeg" },
  ],
  aimsIntro:
